/* ---------------------- Crypto Js -----------------------------
Safe By : https://www.aridjaya.com
Web     : https://cuperhero.blogspot.com

Cara Menggunakan :
1. Cara ENKRIPSI = aesCrypto.encrypt(convertstr('LETAK DISINI TEXT YANG MAU DI ENSKRIPSI'),convertstr('root'));
2. Cara DEKRIPSI = aesCrypto.decrypt(convertstr('LETAK DISINI TEXT YANG MAU DI DEKRIPSI'),convertstr('root'));
*/
...
direct_to_link = 'safelink.hasdukmerahputih.com';
